"""
Django settings for meditation_app_zen_4 project.
...
ROOT_URLCONF = 'meditation_app_zen_4.urls'
...
WSGI_APPLICATION = 'meditation_app_zen_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Meditation App Zen Support <support@meditation-app-zen-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "meditation_app_zen_4 API",
    "DESCRIPTION": "API documentation for meditation_app_zen_4 App",
    "VERSION": "v1",
}
